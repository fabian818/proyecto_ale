...
class CourseAssignmentsControllerTest < ActionController::TestCase
  ...
  test "should create course_assignment" do
    assert_difference('CourseAssignment.count') do
      post :create, course_assignment: { course_id: @course_assignment.course_id, hours_quantity: @course_assignment.hours_quantity, init_date: @course_assignment.init_date, schedule: @course_assignment.schedule, teacher_id: @course_assignment.teacher_id }
    end
  ...
  test "should update course_assignment" do
    patch :update, id: @course_assignment, course_assignment: { course_id: @course_assignment.course_id, hours_quantity: @course_assignment.hours_quantity, init_date: @course_assignment.init_date, schedule: @course_assignment.schedule, teacher_id: @course_assignment.teacher_id }
    assert_redirected_to course_assignment_path(assigns(:course_assignment))
  end
