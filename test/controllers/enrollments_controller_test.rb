...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { course_assignment_id: @enrollment.course_assignment_id, date: @enrollment.date, student_id: @enrollment.student_id }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { course_assignment_id: @enrollment.course_assignment_id, date: @enrollment.date, student_id: @enrollment.student_id }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
